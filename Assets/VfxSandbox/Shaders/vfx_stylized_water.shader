    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Varyings vert(Attributes input)
            {
                ...
                // Điều khiển tần số (scale) và góc nghiêng sóng (alongCoeff) động để tạo hình loe hình quạt (trên nhỏ dưới to)
                float dynamicScale = _RippleScale * (1.0 - along * 0.045);
                ...
                float d_vPhase_dx = (d_perp_dx * 0.8 - d_curvedAlong_dx * alongCoeff + d_vWiggle_dx) * dynamicScale;
                float d_vPhase_dz = (d_perp_dz * 0.8 - d_curvedAlong_dz * alongCoeff + d_vWiggle_dz) * dynamicScale;
